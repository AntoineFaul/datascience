...
def u_net(chanels=3,act='sigmoid'):
    # Build U-Net model
    inputs = Input((224, 224, chanels))
...
#    s = Dropout(0.5)(s)
    ...
    c1 = Conv2D(neurons, (3, 3), activation='relu', padding='same') (inputs)#(inputs)#
    c1 = BatchNormalization()(c1)
    ...
    outputs = Conv2D(3, (1, 1), activation=act) (c9)  #each output row will sum up to 1
