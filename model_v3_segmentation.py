# -*- coding: utf-8 -*-
"""
Created on Sun Jan 13 14:26:14 2019
...
#        #normalisation find better function
...
if __name__ == '__main__':
    ...
    im = np.array(load_transform_pictures('E:\\Projects\\datascience\\polyps\\singletest\\data\\*.jpg'))
    mask = np.array(load_transform_pictures('E:\\Projects\\datascience\\polyps\\singletest\\label\\*.jpg'))
    #mask = to_categorical(mask, num_classes=None)
